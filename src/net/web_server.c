...
"<style>"
"body{font-family:Arial,sans-serif;margin:16px;max-width:860px}"
"h2{margin:0 0 8px}"
...
".section{margin-top:12px;padding-top:8px;border-top:1px solid #e9e9e9}"
...
"</div>"
"<h3 class='section'>MQTT</h3>"
"<div class='row'>"
" <div class='col'><label for='mqtt_host'>Server IP / Host</label><input id='mqtt_host' placeholder='192.168.1.10'/></div>"
" <div class='col'><label for='mqtt_port'>Server Port</label><input id='mqtt_port' type='number' min='1' max='65535'/></div>"
"</div>"
"<div class='row'>"
" <div class='col'><label for='mqtt_user'>Login</label><input id='mqtt_user'/></div>"
" <div class='col'><label for='mqtt_pass'>Password</label><input id='mqtt_pass' type='password'/></div>"
"</div>"
"<div class='row'>"
" <div class='col'><label for='mqtt_device_name'>Device Name</label><input id='mqtt_device_name'/></div>"
" <div class='col'><label for='mqtt_topic_prefix'>Topic Prefix</label><input id='mqtt_topic_prefix' placeholder='auto if empty'/></div>"
"</div>"
"<div class='row'>"
" <div class='col'><label for='mqtt_client_id'>Client ID</label><input id='mqtt_client_id' placeholder='auto if empty'/></div>"
" <div class='col'><label for='mqtt_discovery_prefix'>Discovery Prefix</label><input id='mqtt_discovery_prefix'/></div>"
"</div>"
"<div class='row'>"
" <div class='col check'><input id='mqtt_enable' type='checkbox'/><label for='mqtt_enable'>MQTT enabled</label></div>"
" <div class='col check'><input id='mqtt_discovery' type='checkbox'/><label for='mqtt_discovery'>Home Assistant discovery</label></div>"
" <div class='col check'><input id='mqtt_retain' type='checkbox'/><label for='mqtt_retain'>Retain state</label></div>"
"</div>"
"<div class='row'>"
...
" $('mqtt_enable').checked=(mqtt.enable!==false);"
" $('mqtt_host').value=(mqtt.host||mqtt.server_ip||'');"
" const p=(mqtt.port===undefined?mqtt.server_port:mqtt.port);"
" $('mqtt_port').value=(p===undefined?1883:p);"
" $('mqtt_user').value=(mqtt.user||mqtt.login||'');"
" $('mqtt_pass').value=(mqtt.pass===undefined?(mqtt.password||''):mqtt.pass);"
" $('mqtt_device_name').value=(mqtt.device_name||'ESP32 C3 Relay');"
" $('mqtt_topic_prefix').value=(mqtt.topic_prefix||'');"
" $('mqtt_client_id').value=(mqtt.client_id||'');"
" $('mqtt_discovery_prefix').value=(mqtt.discovery_prefix||'homeassistant');"
" $('mqtt_discovery').checked=(mqtt.discovery!==false);"
" $('mqtt_retain').checked=(mqtt.retain!==false);"
"}"
...
"  cfg.mqtt.enable=$('mqtt_enable').checked;"
"  cfg.mqtt.host=($('mqtt_host').value||'').trim();"
"  const mqttPort=parseInt(($('mqtt_port').value||'1883').trim(),10);"
"  cfg.mqtt.port=(Number.isFinite(mqttPort)&&mqttPort>0&&mqttPort<=65535)?mqttPort:1883;"
"  cfg.mqtt.user=($('mqtt_user').value||'').trim();"
"  cfg.mqtt.pass=($('mqtt_pass').value||'').trim();"
"  cfg.mqtt.client_id=($('mqtt_client_id').value||'').trim();"
"  cfg.mqtt.topic_prefix=($('mqtt_topic_prefix').value||'').trim();"
"  cfg.mqtt.discovery_prefix=($('mqtt_discovery_prefix').value||'homeassistant').trim();"
"  cfg.mqtt.device_name=($('mqtt_device_name').value||'ESP32 C3 Relay').trim();"
"  cfg.mqtt.discovery=$('mqtt_discovery').checked;"
"  cfg.mqtt.retain=$('mqtt_retain').checked;"
"  cfg.mqtt.server_ip=cfg.mqtt.host;"
"  cfg.mqtt.server_port=cfg.mqtt.port;"
"  cfg.mqtt.login=cfg.mqtt.user;"
"  cfg.mqtt.password=cfg.mqtt.pass;"
